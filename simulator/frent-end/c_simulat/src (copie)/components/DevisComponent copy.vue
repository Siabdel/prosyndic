    ...
    <table class="table table-responsive">
      <thead>
        <tr>
          ...
          <th scope="col">Total mensuel TTC </th>
...
export default { 
  ...
  return {
    chargesFonctionnement: [
      ...
      },
      {
        ...
        fields: [
          { name: "Piscines", prixUnitaireMensuel: 0, quantite: 0, nombreMoisAnnuel: 12 },
  ...
  computed: {
    ...
    this.chargesFonctionnement.forEach((rubrique) => {
      rubrique.fields.forEach((field) => {
        // Convertir le nom en minuscules et remplacer les espaces par des soulignés
